...
/**
 * Class ReviewGroupSelfController.
 */
class ReviewGroupSelfController
{
    /**
    ...
    {
        return view('backend.review.group-self.index');
    }
    ...
    {
        return view('backend.review.group-self.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.review.group-self.index')->withFlashSuccess(__('The review was successfully created.'));
    }

    public function show(StudentReview $studentReview)
    {
        return view('backend.review.group-self.show')
            ->with('studentReview',$studentReview);
    }

    public function edit(Request $request, StudentReview $studentReview)
    {
        return view('backend.review.group-self.edit')
            ->with('studentReview',$studentReview);
    }
    ...
    public function update(Request $request, StudentReview $studentReview)
    {
        ...
        return redirect()->route('admin.review.group-self.index', $studentReview)->withFlashSuccess(__('The review was successfully updated.'));
    }
    ...
    public function destroy(Request $request, StudentReview $studentReview)
    {
        ...
        return redirect()->route('admin.review.group-self.index')->withFlashSuccess(__('The review was successfully deleted.'));
    }
}
